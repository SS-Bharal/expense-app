...
<body style="padding-top: 50px;">
    ...
    //  fetching existing email from database
    $sql = "SELECT * FROM `int_expense`.`int_budget` WHERE email='$email' AND id='4'";
    $sql_result = mysqli_query($con, $sql) or die(mysqli_error($con));
    ...
    for ($a = 1; $a <= $row[2]; $a++) {
        ...
        // plan database 
        $sql = "SELECT * FROM `int_expense`.`int_distribution_4` WHERE id='$a'";
        $sql_result = mysqli_query($con, $sql) or die(mysqli_error($con));
    ...
    // refetching
    // plan database 
    $sql = "SELECT * FROM `int_expense`.`int_distribution_4`";
    $sql_result = mysqli_query($con, $sql) or die(mysqli_error($con));
        ...
        <div class="row">
            <div class="col-sm-7">
                ...
                <?php for ($q = 1; $q <= $row[2]; $q++) {
                    // plan database 
                    $sql = "SELECT * FROM `int_expense`.`int_distribution_4` WHERE id='$q'";
                    $sql_result = mysqli_query($con, $sql) or die(mysqli_error($con));
